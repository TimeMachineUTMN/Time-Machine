...
var excluded_tiles = [0, 213,305, 307, 330, 445, 468, 400, 446, 469, 309, 355, 378, 401, 447, 470, 402, 449, 472, 358, 381, 404, 450, 473, 359, 382, 405, 451, 474, 361, 407, 453, 362, 363, 409, 411, 146, 148]; // Тайлы с индексами 0, 5 и 7 будут пропущены

// Получаем тайлмап с этого слоя
var tilemap = layer_tilemap_get_id("Collisions3");
